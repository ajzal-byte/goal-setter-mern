...
import { reset, addUser } from "../../features/adminAuth/adminAuthSlice";
...
const AddUser = () => {
  ...
  const { admin, isLoading, isError, isSuccess, message, isUserAdded } =
  ...
  useEffect(() => {
    ...
    if (isUserAdded || !admin) navigate("/admin/login");
